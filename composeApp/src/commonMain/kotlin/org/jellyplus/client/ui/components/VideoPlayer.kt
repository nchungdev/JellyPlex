...
fun VideoPlayer(
    ...
    VideoPlayerImpl(
        ...
        nextEpisodeConfig, autoSkipIntro, autoSkipOutro, autoSkipPreview, autoNext, customMarkers,
        onPreloadNextMeta, onMarkCurrentAsPlayed, onSaveCustomMarker,
        onToggleAutoSkip, onToggleAutoSkipOutro, onToggleAutoSkipPreview, onToggleAutoNext, onSeamlessNextEpisode,
    )
}
