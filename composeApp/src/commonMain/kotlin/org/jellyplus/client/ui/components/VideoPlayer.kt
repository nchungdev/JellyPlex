...
fun VideoPlayer(
    ...
    VideoPlayerImpl(
        ...
        showSkipEnding, showNextPrev, playbackSpeed, seekBackSeconds, seekForwardSeconds, showGestureHints, uiType,
        nextEpisodeConfig, autoSkipIntro, autoSkipOutro, autoNext, autoPictureInPicture,
        onPreloadNextMeta, onMarkCurrentAsPlayed,
        onToggleAutoSkip, onToggleAutoSkipOutro, onToggleAutoNext, onToggleAutoPictureInPicture, onSeamlessNextEpisode,
