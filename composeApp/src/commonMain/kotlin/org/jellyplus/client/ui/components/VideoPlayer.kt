...
fun VideoPlayer(
    ...
    VideoPlayerImpl(
        ...
        nextEpisodeConfig, autoSkipIntro, autoSkipOutro, autoNext,
        onPreloadNextMeta, onMarkCurrentAsPlayed,
        onToggleAutoSkip, onToggleAutoSkipOutro, onToggleAutoNext, onSeamlessNextEpisode,
    )
}
