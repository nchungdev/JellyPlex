...
import org.jellyplex.client.ui.Screen
import org.jellyplex.client.ui.desktop.screens.DesktopMainScreen
import org.jellyplex.client.ui.mobile.screens.MobileMainScreen
import org.jellyplex.client.ui.viewmodels.MainViewModel
import org.jellyplex.client.ui.viewmodels.MainState
import org.jellyplex.client.ui.viewmodels.PlayerViewModel
...
fun MainScreen(
    ...
    org.jellyplex.client.AppBackHandler(enabled = currentScreen is Screen.Details) {
        currentScreen = Screen.Home
    }

    org.jellyplex.client.AppBackHandler(enabled = currentScreen is Screen.Listing) {
        currentScreen = Screen.Home
    }

    val playerScreen = currentScreen as? Screen.Player
    org.jellyplex.client.AppBackHandler(enabled = playerScreen != null) {
        playerScreen?.let {
    ...
    when (val screen = currentScreen) {
        ...
        is Screen.Player -> {
            ...
            playerState.url?.let { url ->
                org.jellyplex.client.ui.components.VideoPlayer(
                    item = screen.item,
